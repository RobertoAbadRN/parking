...
class DocusignController extends Controller
{
    ...
    private $apiClient, $config, $args, $signer_client_id = 1000;
    /**
     * Show the html page
     *
     * @return render
    ...
    {
        // $docsFilePath = public_path('permiso.pdf');
        $docsFilePath = base_path() . "/permiso.pdf";
    ...
    private function getTemplateArgs()
    {
        $args = [
            ...
            'ds_access_token' => FacadesSession::get('docusign_auth_code'),
            'envelope_args' => [
