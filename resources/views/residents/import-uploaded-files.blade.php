                    ...
                    <table id="residents" class="table-auto min-w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-2">Aparment</th>
                        ...
                        <tbody>
                            @foreach($resident_upload_files as $resident_upload_file)
                                <tr>
                                    @php
                                    ...
                                    <td class="px-4 py-2">
                                        {{ $file_data->lease_expiration }}
                                    </td>
                                    <td class="px-4 py-2">
                                        <a href="{{ route('residents.import.uploaded.files.id', ['upload_id' => $upload_id, 'file_id' => $resident_upload_file->id]) }}" class="text-blue-500 hover:text-blue-700 mr-2">
