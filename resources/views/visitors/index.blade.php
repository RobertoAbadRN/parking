                        ...
                        <tbody>
                            @foreach ($properties as $property)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">
                                        {{ $property->pass_issued }}
                                    </td>
                                    <td class="px-4 py-2">
                                        {{ $property->active_passes }}
                                    </td>
                                    <td class="px-4 py-2">
                                        {{ $property->expired_passes }}
                                    </td>
                                    <td class="px-4 py-2">
                                        {{ $property->invalid_passes }}
                                    </td>
                                    <td class="px-4 py-2">
                                        <a href="{{ route('list.visitors', ['property_code' => $property->property_code]) }}"
