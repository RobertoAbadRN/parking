        ...
        ">
            ...
            <div>
                ...
                <div x-show="openTab ==  2" class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
                    ...
                    <form method="POST" action="{{ route('settings.permit.print.store') }}" name="form-permit-print" id="form-permit-print">
                        <input type="hidden" name="property_id" value="{{$property->id}}">
                        <input type="hidden" name="src" id="src" value="{{asset('images/imgSetting/')}}">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="logo" rowspan="2" class="text-center p-5">
                                                    <img src="{{asset('images/imgSetting/service.png')}}" class="ml-4 img" width="40px" style="margin-top: 1px">
                                                </td>
                                                <td class="space" colspan="2" class="text-center text-base text-gray-900">
                                                    Space or RSVD: ##
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <table cellpadding="5" cellspacing="10" border="0" class="registration">
                                                        <tbody>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label onchange="check_checked(this)">
                                            ...
                                            <div class="check_1 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">Property name</div>
                                        </label>
                                        <label onchange="check_checked(this)">
                                            <input type="checkbox" id="type" name="type" class="hidden">
                                            <div class="check_2 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">Permit Type</div>
                                        </label>
                                        <label onchange="check_checked(this)">
                                            <input type="checkbox" id="space" name="space" class="hidden">
                                            <div class=" check_3 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">Reserved Space</div>
                                        </label>
                                        <label onchange="check_checked(this)">
                                            <input type="checkbox" id="license" name="license" class="hidden">
                                            <div class="check_4 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">License/Plate</div>
                                        </label>
                                    </div>
                                    <div>
                                        <label onchange="check_checked(this)">
                                            <input type="checkbox" id="number" name="number" class="hidden">
                                            <div class="check_5 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">Unit Number</div>
                                        </label>
                                        <label onchange="check_checked(this)">
                                            <input type="checkbox" id="start_date" name="start_date" class="hidden">
                                            <div class="check_6 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">Start Date</div>
                                        </label>
                                        <label onchange="check_checked(this)">
                                            <input type="checkbox" id="end_date" name="end_date" class="hidden">
                                            <div class="check_7 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">End Date</div>
                                        </label>
                                        <label onchange="check_checked(this)">
                                            <input type="checkbox" id="logo" name="logo" class="hidden">
                                            <div class="check_8 p-2 px-2 text-xs bg-red-400 text-white border-b cursor-pointer hover:bg-red-500">Logo</div>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="flex items-center pl-4 dark:border-gray-700">
                                    <label for="bordered-radio" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                        <img src="{{asset('images/imgSetting/property.png')}}" width="50px" height="50px">
                                    </label>
                                    <input id="bordered-radio-1" type="radio" value="property" name="img" class="w-4 h-4" onclick="changeImg('{{asset('images/imgSetting/property.png')}}')">
                                ...
                                <div class="flex items-center pl-4 dark:border-gray-700">
                                    ...
                                    <input id="bordered-radio-2" type="radio" value="service" name="img" class="w-4 h-4" onclick="changeImg('{{asset('images/imgSetting/service.png')}}')">
                                ...
                                <div class="flex items-center pl-4 dark:border-gray-700">
                                    ...
                                    <input id="bordered-radio-3" type="radio" value="default" name="img" class="w-4 h-4" onclick="changeImg('{{asset('images/imgSetting/default.png')}}')">
                                    <label for="bordered-radio-3" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Default</label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class= "mt-2 mb-2">
                                            <img src="{{asset('images/ppm-1-tl.jpg')}}" width="100" class="border-4 border-double border-gray-800">
                                        </div>
                                        <div>
                                            <input id="bordered-radio-ppm1"  type="radio" value="ppm1" name="ppm" class="w-4 h-4">
                                            <label for="bordered-radio-ppm1"  class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                PPM-1
                                            </label>
                                            <br>
                                            <small class="text-xs">Paper sheet with Permit on the top left. The permit is removed from the paper at the perforations and peel the liner to reveal the glue. </small>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                                    <div class="grid grid-cols-2 gap-2">
                                        <div class= "mt-2 mb-2">
                                            <img src="{{asset('images/ppm-2-bl.jpg')}}" width="100" class="border-4 border-double border-gray-800">
                                        </div>
                                        <div>
                                            <input id="bordered-radio-ppm2" type="radio" value="ppm2" name="ppm" class="w-4 h-4">
                                            <label for="bordered-radio-ppm2" class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                PPM-2
                                            </label>
                                            <br>
                                            <small class="text-xs">Paper sheet with Permit on the top left. The permit is removed from the paper at the perforations and peel the liner to reveal the glue. </small>
                ...
                <div x-show="openTab ==  3" class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 shadow-lg shadow-indigo-500/40">
                    <div class="grid grid-cols-1 p-5">
                    <div id="message_margin" class="hidden text-white px-4 py-2 mb-4 rounded-md"></div>
                    <form method="POST" action="{{ route('settings.permit.margin.store') }}" name="form-permit-margin" id="form-permit-margin">
                        <input type="hidden" name="property_id" value="{{$property->id}}">
                        @csrf
                        <div class="grid grid-cols-2 mt-2 gap-4 sm:gap-5 lg:gap-6">
                            <div>
                                Left margin:
                                <input type="number" name="margin_left" id="margin_left" min="-10" max="10" value="0" class="btn btn-submit bg-gray-200 ml-3 font-medium text-gray-900">
                                <br>
                                <small class="text-blue-500">reduce to move LEFT or increase to move RIGHT</small>
                            </div>
                            <div>
                                Top margin:
                                <input type="number" name="margin_top" id="margin_top" min="-10" max="10" value="0" class="btn btn-submit bg-gray-200 ml-3 font-medium text-gray-900">
                                <br>
                                ...
                                <div class="bg-white w-60" style="left: 0em; top: 0em;">
                                    <table style="width: 100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="logo" rowspan="2" class="text-center p-5">
                                                    <img src="{{asset('images/imgSetting/service.png')}}" width="40px" class="ml-4 img" style="margin-top: 1px">
                                                </td>
                                                <td class="space" colspan="2" class="text-center text-base text-gray-900">
                                                    Space or RSVD: ##
                                                </td>
...
<script>
    $(document).ready(function() {
        ...
        $("#form-permit-margin").submit(function( event ) {
            ...
            axios.post('{{ route('settings.permit.margin.store') }}', {
                ...
                if(response.data.success) {
                    ...
                    $('#message_margin').removeClass('hidden').addClass('bg-green-500').text(`${response.data.message}`);
                    setTimeout(function() {
                ...
                if(!response.data.success) {
                    $('#message_margin').removeClass('hidden').addClass('bg-red-500').text(`${response.data.message}`);
                    setTimeout(function() {
                        $('#message_margin').addClass('hidden').text('');
                    }, 5000);
                }
        ...
        $("#form-permit-print").submit(function( event ) {
            event.preventDefault();
            $('.btn-submit').prop("disabled", true);
            axios.post('{{ route('settings.permit.print.store') }}', $(this).serialize(),{
            }).then(response => {
                if(response.data.success) {
                    languageSetting($('#language').val());
                    $('#message_print').removeClass('hidden').addClass('bg-green-500').text(`${response.data.message}`);
                    setTimeout(function() {
                ...
                if(!response.data.success) {
                    $('#message_print').removeClass('hidden').addClass('bg-red-500').text(`${response.data.message}`);
                    setTimeout(function() {
                        $('#message_print').addClass('hidden').text('');
                    }, 5000);
                }
                ...
                if(response.data.success) {
                   ...
                   if(response.data.propertySetting){
                    ...
                    $('#instructions').html(function(){
                        ...
                        if(lan == 'es') {
                            htmlt_int +=`<p class="text-center text-2xl text-gray-900  mt-5">Instrucciones</p>`;
                        ...
                        if(lan == 'en') {
                            htmlt_int +=`<p class="text-center text-2xl text-gray-900  mt-5">Instructions</p>`;
                            htmlt_int +=`<ul class="list-disc ml-5 p-5 text-gray-950">`;
