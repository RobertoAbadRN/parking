                ...
                <div class="inline-flex space-x-4">
                    <div class="inline-flex space-x-4">
                        ...
                        <a href="{{ route('adduser') }}"
                            class="btn btn-xs bg-info font-medium text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90">
                            <i class="fa fa-user"></i>
                            &nbsp;Add user
                        </a>
                        <a href="https://www.findmytowedcar.com/" target="_blank"
