                    ...
                    <form action="{{ route('users.store') }}" method="POST">
                            ...
                            <label class="relative flex">
                                ...
                                <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-2">
                                    <svg class="w-5 h-5 text-slate-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M2.586 5.586a2 2 0 012.828 0L10 9.172l4.586-4.586a2 2 0 012.828 2.828L12.828 12l4.586 4.586a2 2 0 01-2.828 2.828L10 14.828l-4.586 4.586a2 2 0 01-2.828-2.828L7.172 12 2.586 7.414a2 2 0 010-2.828z" clip-rule="evenodd" />
                                    </svg>
                                </span>
                            </label>
                            @error('username')
                        ...
                        <div class="mb-4">
                            <label class="relative flex">
                                ...
                                <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-2">
                                    <svg class="w-5 h-5 text-slate-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M10 1a9 9 0 100 18 9 9 0 000-18zm-1 16V9a1 1 0 012 0v8a1 1 0 01-2 0zm1-10a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" />
                                    </svg>
                                </span>
                            </label>
                            @error('name')
                        ...
                        <div class="mb-4">
                            <label class="relative flex">
                                ...
                                <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-2">
                                    <svg class="w-5 h-5 text-slate-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd" d="M3 4a1 1 0 00-1 1v8a1 1 0 001 1h1v3l2-1h6a1 1 0 001-1V5a1 1 0 00-1-1H3zm1 2h12v6H4V6zm0 2v2h3v-2H4zm5 0v2h2v-2H9zm3 0v2h2v-2h-2zM4 13h3v-2H4v2zm5 0h2v-2H9v2zm3 0h2v-2h-2v2z" clip-rule="evenodd" />
                                    </svg>
                                </span>
                            </label>
                            @error('phone')
