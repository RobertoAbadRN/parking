            ...
            <div class="card mt-5 rounded-lg p-5 lg:p-7">
                ...
                <form class="mt-16 mb-10" action="{{ route('login') }}" method="post">
                    ...
                    <div class="mt-4 flex items-center justify-between space-x-2">
                        ...
                        <a href="{{route('forget.password.get') }}" class="text-xs text-slate-400 transition-colors line-clamp-1 hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100">Forgot Password?</a>
