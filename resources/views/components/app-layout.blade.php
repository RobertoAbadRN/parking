...
<head>
    ...
    @endisset
          ...
          <!-- Agregar el archivo de estilo del DataTables -->
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.25/css/jquery.dataTables.min.css">

<!-- Agregar el archivo de estilo del DataTables Responsive -->
